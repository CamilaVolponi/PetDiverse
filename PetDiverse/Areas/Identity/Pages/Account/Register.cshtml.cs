...
namespace PetDiverse.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
        ...
        private IdentityUser CreateUser()
        {
            ...
            catch
            {
                throw new InvalidOperationException($"Não é possível criar uma instância de '{nameof(IdentityUser)}'. " +
                    $"Certifique-se de que '{nameof(IdentityUser)}' não seja uma classe abstrata e possua um construtor sem parâmetros, ou alternativamente" +
                    $"substitua (override) a página de registro em /Areas/Identity/Pages/Account/Register.cshtml");
            }
        }
